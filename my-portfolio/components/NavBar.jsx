  ...
  return (
    <nav className="w-full fixed flex items-center justify-between px-6 py-4 lg:px-8 xl:px-[8%] bg-white shadow-md z-50">
      ...
      <div className="flex items-center, gap-4"> 
        ...
        <a href="#contact" className='hidden lg:flex items-center box-border border-2 border-black/50 justify-center px-8 py-3 ml-4 rounded-full hover:bg-gray-800 transition-all duration-200 ease-in-out'> Contact </a> 

        <button className="block md:hidden ml-4"onClick={openMenu}>
            <Image src="/menu-outline.png" alt="" width={24} height={24} className="w-6 " />
        </button>
        </div>
        ...
        <div className="absolute right-6 top-6" onClick={closeMenu}>
            <Image src="/close-outline.png" alt="" width={24} height={24} className="w-6 cursor-pointer"/>
        </div>
